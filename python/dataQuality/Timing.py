...
#		hBxIdOther.Sumw2()
		...
		hBxIdBest.SetLineWidth(3)
		hBxIdBest.SetStats(0)
		hBxIdBest.SetTitle("Matched DT/RPC + HO;Time / ns;rel. fraction / 2 ns")
		...
		hBxIdDtOnly.SetLineWidth(3)
		hBxIdDtOnly.SetStats(0)
		hBxIdDtOnly.SetTitle("Unmatched DT + HO;Time / ns;rel. fraction / 2 ns")
		...
		hBxIdOther.SetLineWidth(3)
		hBxIdOther.SetStats(0)
		hBxIdOther.SetTitle("Lower quality muon + HO;Time / ns;rel. fraction / 2 ns")
	...
	def plotHoTimeLog(self):
		...
		hHoTimeAboveThr.SetTitle(';Time / ns;Entries / 2 ns')
